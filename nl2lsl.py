...
def nl2lsl(UDP_IP="192.168.3.100", UDP_PORT=26090, nBoards=2, srate=1024):
	# UDP_IP = "127.0.0.1"
	# UDP_PORT = 5005 
	...
	# create LSL stream
	info = StreamInfo('NeuraLynx', 'EEG', nChannels, srate, 'float32', 'myuid34234')
	...
	while True:
		...
		header = struct.unpack_from('!3Id2I10I',packet,offset = 0)
...
if __name__ == '__main__':
	...
	nl2lsl(args.ip, args.port, args.nBoards, args.srate)
